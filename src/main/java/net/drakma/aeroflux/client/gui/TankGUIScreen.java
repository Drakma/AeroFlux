...
public class TankGUIScreen extends AbstractContainerScreen<TankGUIMenu> implements AerofluxModScreens.ScreenAccessor {
	...
	public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		if (SettingsStatusProcedure.execute(world))
			if (mouseX > leftPos + -29 && mouseX < leftPos + -17 && mouseY > topPos + 30 && mouseY < topPos + 42) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_up"), mouseX, mouseY);
			}
		if (SettingsStatusProcedure.execute(world))
			if (mouseX > leftPos + -29 && mouseX < leftPos + -17 && mouseY > topPos + 43 && mouseY < topPos + 55) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_front"), mouseX, mouseY);
			}
		if (SettingsStatusProcedure.execute(world))
			if (mouseX > leftPos + -29 && mouseX < leftPos + -17 && mouseY > topPos + 56 && mouseY < topPos + 68) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_down"), mouseX, mouseY);
			}
		if (SettingsStatusProcedure.execute(world))
			if (mouseX > leftPos + -16 && mouseX < leftPos + -4 && mouseY > topPos + 56 && mouseY < topPos + 68) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_back"), mouseX, mouseY);
			}
		if (SettingsStatusProcedure.execute(world))
			if (mouseX > leftPos + -16 && mouseX < leftPos + -4 && mouseY > topPos + 43 && mouseY < topPos + 55) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_right"), mouseX, mouseY);
			}
		if (SettingsStatusProcedure.execute(world))
			if (mouseX > leftPos + -42 && mouseX < leftPos + -30 && mouseY > topPos + 43 && mouseY < topPos + 55) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_left"), mouseX, mouseY);
			}
		if (mouseX > leftPos + 4 && mouseX < leftPos + 12 && mouseY > topPos + 5 && mouseY < topPos + 13) {
			guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_settings"), mouseX, mouseY);
		}
		...
		if (SettingsStatusProcedure.execute(world))
			if (mouseX > leftPos + -42 && mouseX < leftPos + -30 && mouseY > topPos + 56 && mouseY < topPos + 68) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_rotate"), mouseX, mouseY);
			}
		if (AlwaysOnProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -42 && mouseX < leftPos + -30 && mouseY > topPos + 4 && mouseY < topPos + 16) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_always_on"), mouseX, mouseY);
			}
		if (RedstoneRequiredProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -42 && mouseX < leftPos + -30 && mouseY > topPos + 4 && mouseY < topPos + 16) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_redstone_required"), mouseX, mouseY);
			}
		if (RedstoneSignalOffProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -29 && mouseX < leftPos + -4 && mouseY > topPos + 4 && mouseY < topPos + 16) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_redstone_signal_off"), mouseX, mouseY);
			}
		if (RedstoneSignalOnProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -29 && mouseX < leftPos + -4 && mouseY > topPos + 4 && mouseY < topPos + 16) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_redstone_signal_on"), mouseX, mouseY);
			}
		if (RedstoneSignalLevelProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -29 && mouseX < leftPos + -4 && mouseY > topPos + 4 && mouseY < topPos + 16) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_redstone_signal_levels"), mouseX, mouseY);
			}
		if (AutoExportOnProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -42 && mouseX < leftPos + -30 && mouseY > topPos + 30 && mouseY < topPos + 42) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_auto_export"), mouseX, mouseY);
			}
		if (AutoExportOffProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -42 && mouseX < leftPos + -30 && mouseY > topPos + 30 && mouseY < topPos + 42) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_auto_export_off"), mouseX, mouseY);
			}
		if (ImportSettingsOnProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -42 && mouseX < leftPos + -4 && mouseY > topPos + 17 && mouseY < topPos + 29) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_import_settings"), mouseX, mouseY);
			}
		if (ExportSettingsOnProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -42 && mouseX < leftPos + -4 && mouseY > topPos + 17 && mouseY < topPos + 29) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_export_settings"), mouseX, mouseY);
			}
		if (AutoImportOnProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -16 && mouseX < leftPos + -4 && mouseY > topPos + 31 && mouseY < topPos + 42) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_auto_import_on"), mouseX, mouseY);
			}
		if (AutoImportOffProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -16 && mouseX < leftPos + -4 && mouseY > topPos + 30 && mouseY < topPos + 42) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_auto_import_off"), mouseX, mouseY);
			}
		if (mouseX > leftPos + 61 && mouseX < leftPos + 79 && mouseY > topPos + 58 && mouseY < topPos + 76) {
			guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.tank_gui.tooltip_fill_or_empty_buckets"), mouseX, mouseY);
		}
	...
	public void extractBackground(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (SettingsStatusProcedure.execute(world)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_1, this.leftPos + -47, this.topPos + 0, 0, 0, 51, 61, 51, 61);
		}
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_2, this.leftPos + 13, this.topPos + 34, 0, 0, 161, 10, 161, 10);
		if (FilledSomeProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_3, this.leftPos + 14, this.topPos + 35, 0, 0, 161, 10, 161, 10);
		}
		if (Filled10Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_4, this.leftPos + 14, this.topPos + 35, 0, 0, 161, 10, 161, 10);
		}
		if (Filled20Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_5, this.leftPos + 14, this.topPos + 35, 0, 0, 161, 10, 161, 10);
		}
		if (Filled30Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_6, this.leftPos + 14, this.topPos + 35, 0, 0, 161, 10, 161, 10);
		}
		if (Filled40Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_7, this.leftPos + 14, this.topPos + 35, 0, 0, 161, 10, 161, 10);
		}
		if (Filled50Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_8, this.leftPos + 14, this.topPos + 35, 0, 0, 161, 10, 161, 10);
		}
		if (Filled60Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_9, this.leftPos + 14, this.topPos + 35, 0, 0, 161, 10, 161, 10);
		}
		if (Filled70Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_10, this.leftPos + 14, this.topPos + 35, 0, 0, 161, 10, 161, 10);
		}
		if (Filled80Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_11, this.leftPos + 14, this.topPos + 35, 0, 0, 161, 10, 161, 10);
		}
		if (Filled90Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_12, this.leftPos + 14, this.topPos + 35, 0, 0, 161, 10, 161, 10);
		}
		if (Filled100Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_13, this.leftPos + 14, this.topPos + 35, 0, 0, 161, 10, 161, 10);
		}
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_14, this.leftPos + 61, this.topPos + 58, 0, 0, 17, 17, 17, 17);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_15, this.leftPos + 97, this.topPos + 58, 0, 0, 17, 17, 17, 17);
	}
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, GetBlockNameProcedure.execute(world, x, y, z), 16, 5, -12829636, false);
	}

	@Override
	public void init() {
		super.init();
		imagebutton_side_button_no = new ImageButton(this.leftPos + -29, this.topPos + 30, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_button_no.png"), Identifier.parse("aeroflux:textures/screens/side_button_no.png")),
				e -> {
		...
		imagebutton_side_button_no1 = new ImageButton(this.leftPos + -42, this.topPos + 43, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_button_no.png"), Identifier.parse("aeroflux:textures/screens/side_button_no.png")),
				e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (SettingsStatusExportProcedure.execute(world, x, y, z)) {
		...
		imagebutton_side_button_no2 = new ImageButton(this.leftPos + -29, this.topPos + 43, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_button_no.png"), Identifier.parse("aeroflux:textures/screens/side_button_no.png")),
				e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (SettingsStatusExportProcedure.execute(world, x, y, z)) {
		...
		imagebutton_side_button_no3 = new ImageButton(this.leftPos + -16, this.topPos + 43, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_button_no.png"), Identifier.parse("aeroflux:textures/screens/side_button_no.png")),
				e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (SettingsStatusExportProcedure.execute(world, x, y, z)) {
		...
		imagebutton_side_button_no4 = new ImageButton(this.leftPos + -29, this.topPos + 56, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_button_no.png"), Identifier.parse("aeroflux:textures/screens/side_button_no.png")),
				e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (SettingsStatusExportProcedure.execute(world, x, y, z)) {
		...
		imagebutton_side_button_no5 = new ImageButton(this.leftPos + -16, this.topPos + 56, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_button_no.png"), Identifier.parse("aeroflux:textures/screens/side_button_no.png")),
				e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (SettingsStatusExportProcedure.execute(world, x, y, z)) {
		...
		imagebutton_settings_closed = new ImageButton(this.leftPos + 2, this.topPos + 3, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/settings_closed.png"), Identifier.parse("aeroflux:textures/screens/settings_closed.png")),
				e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (true) {
		...
		imagebutton_settings_open = new ImageButton(this.leftPos + 2, this.topPos + 3, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/settings_open.png"), Identifier.parse("aeroflux:textures/screens/settings_open.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
			if (SettingsStatusProcedure.execute(world)) {
		...
		imagebutton_rotate = new ImageButton(this.leftPos + -42, this.topPos + 56, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/rotate.png"), Identifier.parse("aeroflux:textures/screens/rotate.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
			if (SettingsStatusProcedure.execute(world)) {
		...
		imagebutton_redstone_alwayson = new ImageButton(this.leftPos + -42, this.topPos + 4, 12, 12,
				new WidgetSprites(Identifier.parse("aeroflux:textures/screens/redstone_alwayson.png"), Identifier.parse("aeroflux:textures/screens/redstone_alwayson.png")), e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (AlwaysOnProcedure.execute(world, x, y, z)) {
		...
		imagebutton_redstone_required = new ImageButton(this.leftPos + -42, this.topPos + 4, 12, 12,
				new WidgetSprites(Identifier.parse("aeroflux:textures/screens/redstone_required.png"), Identifier.parse("aeroflux:textures/screens/redstone_required.png")), e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (RedstoneRequiredProcedure.execute(world, x, y, z)) {
		...
		imagebutton_redstone_signal_off = new ImageButton(this.leftPos + -29, this.topPos + 4, 25, 12,
				new WidgetSprites(Identifier.parse("aeroflux:textures/screens/redstone_signal_off.png"), Identifier.parse("aeroflux:textures/screens/redstone_signal_off.png")), e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (RedstoneSignalOffProcedure.execute(world, x, y, z)) {
		...
		imagebutton_redstone_signal_on = new ImageButton(this.leftPos + -29, this.topPos + 4, 25, 12,
				new WidgetSprites(Identifier.parse("aeroflux:textures/screens/redstone_signal_on.png"), Identifier.parse("aeroflux:textures/screens/redstone_signal_on.png")), e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (RedstoneSignalOnProcedure.execute(world, x, y, z)) {
		...
		imagebutton_redstone_signal_level = new ImageButton(this.leftPos + -29, this.topPos + 4, 25, 12,
				new WidgetSprites(Identifier.parse("aeroflux:textures/screens/redstone_signal_level.png"), Identifier.parse("aeroflux:textures/screens/redstone_signal_level.png")), e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (RedstoneSignalLevelProcedure.execute(world, x, y, z)) {
		...
		imagebutton_auto_export_off = new ImageButton(this.leftPos + -42, this.topPos + 30, 12, 12,
				new WidgetSprites(Identifier.parse("aeroflux:textures/screens/auto_export_off.png"), Identifier.parse("aeroflux:textures/screens/auto_export_off.png")), e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (AutoExportOffProcedure.execute(world, x, y, z)) {
		...
		imagebutton_auto_export = new ImageButton(this.leftPos + -42, this.topPos + 30, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/auto_export.png"), Identifier.parse("aeroflux:textures/screens/auto_export.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
			if (AutoExportOnProcedure.execute(world, x, y, z)) {
		...
		imagebutton_settings_export = new ImageButton(this.leftPos + -42, this.topPos + 17, 38, 12,
				new WidgetSprites(Identifier.parse("aeroflux:textures/screens/settings_export.png"), Identifier.parse("aeroflux:textures/screens/settings_export.png")), e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (ExportSettingsOnProcedure.execute(world, x, y, z)) {
		...
		imagebutton_settings_import = new ImageButton(this.leftPos + -42, this.topPos + 17, 38, 12,
				new WidgetSprites(Identifier.parse("aeroflux:textures/screens/settings_import.png"), Identifier.parse("aeroflux:textures/screens/settings_import.png")), e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (ImportSettingsOnProcedure.execute(world, x, y, z)) {
		...
		imagebutton_auto_import = new ImageButton(this.leftPos + -16, this.topPos + 30, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/auto_import.png"), Identifier.parse("aeroflux:textures/screens/auto_import.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
			if (AutoImportOnProcedure.execute(world, x, y, z)) {
		...
		imagebutton_auto_import_off = new ImageButton(this.leftPos + -16, this.topPos + 30, 12, 12,
				new WidgetSprites(Identifier.parse("aeroflux:textures/screens/auto_import_off.png"), Identifier.parse("aeroflux:textures/screens/auto_import_off.png")), e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (AutoImportOffProcedure.execute(world, x, y, z)) {
		...
		imagebutton_side_export = new ImageButton(this.leftPos + -29, this.topPos + 30, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_export.png"), Identifier.parse("aeroflux:textures/screens/side_export.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
		...
		imagebutton_side_export1 = new ImageButton(this.leftPos + -42, this.topPos + 43, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_export.png"), Identifier.parse("aeroflux:textures/screens/side_export.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
		...
		imagebutton_side_export2 = new ImageButton(this.leftPos + -29, this.topPos + 43, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_export.png"), Identifier.parse("aeroflux:textures/screens/side_export.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
		...
		imagebutton_side_export3 = new ImageButton(this.leftPos + -16, this.topPos + 43, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_export.png"), Identifier.parse("aeroflux:textures/screens/side_export.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
		...
		imagebutton_side_export4 = new ImageButton(this.leftPos + -29, this.topPos + 56, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_export.png"), Identifier.parse("aeroflux:textures/screens/side_export.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
		...
		imagebutton_side_export5 = new ImageButton(this.leftPos + -16, this.topPos + 56, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_export.png"), Identifier.parse("aeroflux:textures/screens/side_export.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
		...
		imagebutton_side_button_no6 = new ImageButton(this.leftPos + -29, this.topPos + 30, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_button_no.png"), Identifier.parse("aeroflux:textures/screens/side_button_no.png")),
				e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
		...
		imagebutton_side_button_no7 = new ImageButton(this.leftPos + -42, this.topPos + 43, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_button_no.png"), Identifier.parse("aeroflux:textures/screens/side_button_no.png")),
				e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (SettingsStatusImportProcedure.execute(world, x, y, z)) {
		...
		imagebutton_side_button_no8 = new ImageButton(this.leftPos + -29, this.topPos + 43, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_button_no.png"), Identifier.parse("aeroflux:textures/screens/side_button_no.png")),
				e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (SettingsStatusImportProcedure.execute(world, x, y, z)) {
		...
		imagebutton_side_button_no9 = new ImageButton(this.leftPos + -16, this.topPos + 43, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_button_no.png"), Identifier.parse("aeroflux:textures/screens/side_button_no.png")),
				e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (SettingsStatusImportProcedure.execute(world, x, y, z)) {
		...
		imagebutton_side_button_no10 = new ImageButton(this.leftPos + -29, this.topPos + 56, 12, 12,
				new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_button_no.png"), Identifier.parse("aeroflux:textures/screens/side_button_no.png")), e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (SettingsStatusImportProcedure.execute(world, x, y, z)) {
		...
		imagebutton_side_button_no11 = new ImageButton(this.leftPos + -16, this.topPos + 56, 12, 12,
				new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_button_no.png"), Identifier.parse("aeroflux:textures/screens/side_button_no.png")), e -> {
					int x = TankGUIScreen.this.x;
					int y = TankGUIScreen.this.y;
					if (SettingsStatusImportProcedure.execute(world, x, y, z)) {
		...
		imagebutton_side_export6 = new ImageButton(this.leftPos + -29, this.topPos + 30, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_import.png"), Identifier.parse("aeroflux:textures/screens/side_import.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
		...
		imagebutton_side_import = new ImageButton(this.leftPos + -42, this.topPos + 43, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_import.png"), Identifier.parse("aeroflux:textures/screens/side_import.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
		...
		imagebutton_side_import1 = new ImageButton(this.leftPos + -29, this.topPos + 43, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_import.png"), Identifier.parse("aeroflux:textures/screens/side_import.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
		...
		imagebutton_side_import2 = new ImageButton(this.leftPos + -16, this.topPos + 43, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_import.png"), Identifier.parse("aeroflux:textures/screens/side_import.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
		...
		imagebutton_side_import3 = new ImageButton(this.leftPos + -29, this.topPos + 56, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_import.png"), Identifier.parse("aeroflux:textures/screens/side_import.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
		...
		imagebutton_side_import4 = new ImageButton(this.leftPos + -16, this.topPos + 56, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/side_import.png"), Identifier.parse("aeroflux:textures/screens/side_import.png")), e -> {
			int x = TankGUIScreen.this.x;
			int y = TankGUIScreen.this.y;
		...
		imagebutton_arrow_right = new ImageButton(this.leftPos + 80, this.topPos + 59, 16, 16, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/arrow_right.png"), Identifier.parse("aeroflux:textures/screens/arrow_right.png")), e -> {
		}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
				guiGraphics.blit(RenderPipelines.GUI_TEXTURED, sprites.get(isActive(), isHoveredOrFocused()), getX(), getY(), 0, 0, width, height, width, height);
		...
		imagebutton_bucket = new ImageButton(this.leftPos + 62, this.topPos + 59, 16, 16, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/bucket.png"), Identifier.parse("aeroflux:textures/screens/bucket.png")), e -> {
		}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
				guiGraphics.blit(RenderPipelines.GUI_TEXTURED, sprites.get(isActive(), isHoveredOrFocused()), getX(), getY(), 0, 0, width, height, width, height);
