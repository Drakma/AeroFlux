...
public class CollectorGUIScreen extends AbstractContainerScreen<CollectorGUIMenu> implements AerofluxModScreens.ScreenAccessor {
	...
	public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (AlwaysOnProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -61 && mouseX < leftPos + -49 && mouseY > topPos + 13 && mouseY < topPos + 25) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_always_on"), mouseX, mouseY);
			}
		if (RedstoneRequiredProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -61 && mouseX < leftPos + -49 && mouseY > topPos + 13 && mouseY < topPos + 25) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_redstone_required"), mouseX, mouseY);
			}
		if (RedstoneSignalOffProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -48 && mouseX < leftPos + -23 && mouseY > topPos + 13 && mouseY < topPos + 25) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_redstone_signal_off"), mouseX, mouseY);
			}
		if (RedstoneSignalOnProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -48 && mouseX < leftPos + -23 && mouseY > topPos + 13 && mouseY < topPos + 25) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_redstone_signal_on"), mouseX, mouseY);
			}
		if (RedstoneSignalLevelProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -48 && mouseX < leftPos + -23 && mouseY > topPos + 13 && mouseY < topPos + 25) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_redstone_signal_levels"), mouseX, mouseY);
			}
		if (CapabilityRedstoneProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -15 && mouseX < leftPos + -1 && mouseY > topPos + 0 && mouseY < topPos + 14) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_redstone_settings"), mouseX, mouseY);
			}
		if (CapabilityFluidProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -15 && mouseX < leftPos + -1 && mouseY > topPos + 15 && mouseY < topPos + 29) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_fluid_settings"), mouseX, mouseY);
			}
		if (CapabilityItemsProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -15 && mouseX < leftPos + -1 && mouseY > topPos + 30 && mouseY < topPos + 44) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_item_settings"), mouseX, mouseY);
			}
		if (CapabilityEnergyProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + -15 && mouseX < leftPos + -1 && mouseY > topPos + 46 && mouseY < topPos + 60) {
				guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_energy_settings"), mouseX, mouseY);
			}
		if (mouseX > leftPos + -14 && mouseX < leftPos + -2 && mouseY > topPos + 141 && mouseY < topPos + 153) {
			guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_change_light_mode"), mouseX, mouseY);
		}
		...
		if (mouseX > leftPos + -66 && mouseX < leftPos + -57 && mouseY > topPos + 1 && mouseY < topPos + 10) {
			guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_close"), mouseX, mouseY);
		}
		if (mouseX > leftPos + -48 && mouseX < leftPos + -36 && mouseY > topPos + 36 && mouseY < topPos + 48) {
			guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_up"), mouseX, mouseY);
		}
		if (mouseX > leftPos + -61 && mouseX < leftPos + -49 && mouseY > topPos + 49 && mouseY < topPos + 61) {
			guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_left"), mouseX, mouseY);
		}
		if (mouseX > leftPos + -48 && mouseX < leftPos + -36 && mouseY > topPos + 49 && mouseY < topPos + 61) {
			guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_front"), mouseX, mouseY);
		}
		if (mouseX > leftPos + -35 && mouseX < leftPos + -23 && mouseY > topPos + 49 && mouseY < topPos + 61) {
			guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_right"), mouseX, mouseY);
		}
		if (mouseX > leftPos + -48 && mouseX < leftPos + -36 && mouseY > topPos + 62 && mouseY < topPos + 74) {
			guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_down"), mouseX, mouseY);
		}
		if (mouseX > leftPos + -35 && mouseX < leftPos + -23 && mouseY > topPos + 62 && mouseY < topPos + 74) {
			guiGraphics.setTooltipForNextFrame(font, Component.translatable("gui.aeroflux.collector_gui.tooltip_back"), mouseX, mouseY);
		}
	...
	public void extractBackground(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (IsSettingsLightProcedure.execute(world)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_3, this.leftPos + -67, this.topPos + 0, 0, 0, 51, 80, 51, 80);
		}
		if (IsSettingsDarkProcedure.execute(world)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_4, this.leftPos + -67, this.topPos + 0, 0, 0, 51, 80, 51, 80);
		}
		if (IsSettingsMediumProcedure.execute(world)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_5, this.leftPos + -67, this.topPos + 0, 0, 0, 51, 80, 51, 80);
		}
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_6, this.leftPos + 13, this.topPos + 29, 0, 0, 150, 25, 150, 25);
		if (IsRainingProcedure.execute(world)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_7, this.leftPos + 13, this.topPos + 29, 0, 0, 150, 25, 150, 25);
		}
		if (IsStormingProcedure.execute(world)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_8, this.leftPos + 13, this.topPos + 29, 0, 0, 150, 25, 150, 25);
		}
		if (IsSunriseProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_9, this.leftPos + 11, this.topPos + 27, 0, 0, 41, 29, 41, 29);
		}
		if (IsDaytimeProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_10, this.leftPos + 50, this.topPos + 27, 0, 0, 41, 29, 41, 29);
		}
		if (IsSunsetProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_11, this.leftPos + 89, this.topPos + 27, 0, 0, 41, 29, 41, 29);
		}
		if (IsNightProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_12, this.leftPos + 124, this.topPos + 27, 0, 0, 41, 29, 41, 29);
		}
		if (CantSeeSkyProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_13, this.leftPos + 13, this.topPos + 29, 0, 0, 150, 25, 150, 25);
		}
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_14, this.leftPos + 8, this.topPos + 65, 0, 0, 161, 10, 161, 10);
		if (FilledSomeProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_15, this.leftPos + 8, this.topPos + 65, 0, 0, 161, 10, 161, 10);
		}
		if (Filled10Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_16, this.leftPos + 8, this.topPos + 65, 0, 0, 161, 10, 161, 10);
		}
		if (Filled20Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_17, this.leftPos + 8, this.topPos + 65, 0, 0, 161, 10, 161, 10);
		}
		if (Filled30Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_18, this.leftPos + 8, this.topPos + 65, 0, 0, 161, 10, 161, 10);
		}
		if (Filled40Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_19, this.leftPos + 8, this.topPos + 65, 0, 0, 161, 10, 161, 10);
		}
		if (Filled50Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_20, this.leftPos + 8, this.topPos + 65, 0, 0, 161, 10, 161, 10);
		}
		if (Filled60Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_21, this.leftPos + 8, this.topPos + 65, 0, 0, 161, 10, 161, 10);
		}
		if (Filled70Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_22, this.leftPos + 8, this.topPos + 65, 0, 0, 161, 10, 161, 10);
		}
		if (Filled80Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_23, this.leftPos + 8, this.topPos + 65, 0, 0, 161, 10, 161, 10);
		}
		if (Filled90Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_24, this.leftPos + 8, this.topPos + 65, 0, 0, 161, 10, 161, 10);
		}
		if (Filled100Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_25, this.leftPos + 8, this.topPos + 65, 0, 0, 161, 10, 161, 10);
		}
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_26, this.leftPos + 8, this.topPos + 65, 0, 0, 161, 10, 161, 10);
	}
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, GetBlockNameProcedure.execute(world, x, y, z), 12, 7, -12829636, false);
		if (CantSeeSkyProcedure.execute(world, x, y, z))
			guiGraphics.text(this.font, Component.translatable("gui.aeroflux.collector_gui.label_sky_ubstructed"), 55, 38, -3355444, false);
	}

	@Override
	public void init() {
		super.init();
		imagebutton_side_button_no = new ImageButton(this.leftPos + -48, this.topPos + 36, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/off.png"), Identifier.parse("aeroflux:textures/screens/off.png")), e -> {
		...
		imagebutton_side_button_no1 = new ImageButton(this.leftPos + -61, this.topPos + 49, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/off.png"), Identifier.parse("aeroflux:textures/screens/off.png")), e -> {
			int x = CollectorGUIScreen.this.x;
			int y = CollectorGUIScreen.this.y;
			if (SettingsStatusProcedure.execute(world)) {
		...
		imagebutton_side_button_no2 = new ImageButton(this.leftPos + -48, this.topPos + 49, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/off.png"), Identifier.parse("aeroflux:textures/screens/off.png")), e -> {
			int x = CollectorGUIScreen.this.x;
			int y = CollectorGUIScreen.this.y;
			if (SettingsStatusProcedure.execute(world)) {
		...
		imagebutton_side_button_no3 = new ImageButton(this.leftPos + -35, this.topPos + 49, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/off.png"), Identifier.parse("aeroflux:textures/screens/off.png")), e -> {
			int x = CollectorGUIScreen.this.x;
			int y = CollectorGUIScreen.this.y;
			if (SettingsStatusProcedure.execute(world)) {
		...
		imagebutton_side_button_no4 = new ImageButton(this.leftPos + -48, this.topPos + 62, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/off.png"), Identifier.parse("aeroflux:textures/screens/off.png")), e -> {
			int x = CollectorGUIScreen.this.x;
			int y = CollectorGUIScreen.this.y;
			if (SettingsStatusProcedure.execute(world)) {
		...
		imagebutton_side_button_no5 = new ImageButton(this.leftPos + -35, this.topPos + 62, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/off.png"), Identifier.parse("aeroflux:textures/screens/off.png")), e -> {
			int x = CollectorGUIScreen.this.x;
			int y = CollectorGUIScreen.this.y;
			if (SettingsStatusProcedure.execute(world)) {
		...
		imagebutton_redstone_alwayson = new ImageButton(this.leftPos + -61, this.topPos + 13, 12, 12,
		...
		imagebutton_redstone_required = new ImageButton(this.leftPos + -61, this.topPos + 13, 12, 12,
		...
		imagebutton_redstone_signal_off = new ImageButton(this.leftPos + -48, this.topPos + 13, 25, 12,
		...
		imagebutton_redstone_signal_on = new ImageButton(this.leftPos + -48, this.topPos + 13, 25, 12,
		...
		imagebutton_redstone_signal_level = new ImageButton(this.leftPos + -48, this.topPos + 13, 25, 12,
		...
		imagebutton_auto_export = new ImageButton(this.leftPos + -97, this.topPos + 59, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/auto_export.png"), Identifier.parse("aeroflux:textures/screens/auto_export.png")), e -> {
			int x = CollectorGUIScreen.this.x;
			int y = CollectorGUIScreen.this.y;
		...
		imagebutton_tab_redstone = new ImageButton(this.leftPos + -15, this.topPos + 0, 14, 14, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/tab_redstone_off.png"), Identifier.parse("aeroflux:textures/screens/tab_redstone_off.png")),
				e -> {
					int x = CollectorGUIScreen.this.x;
					int y = CollectorGUIScreen.this.y;
					if (CapabilityRedstoneProcedure.execute(world, x, y, z)) {
		...
		imagebutton_tab_redstone_selected = new ImageButton(this.leftPos + -15, this.topPos + 0, 14, 14,
		...
		imagebutton_tab_fluid = new ImageButton(this.leftPos + -15, this.topPos + 15, 14, 14, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/tab_fluid_off.png"), Identifier.parse("aeroflux:textures/screens/tab_fluid_off.png")), e -> {
			int x = CollectorGUIScreen.this.x;
			int y = CollectorGUIScreen.this.y;
			if (CapabilityFluidProcedure.execute(world, x, y, z)) {
		...
		imagebutton_tab_fluid_selected = new ImageButton(this.leftPos + -15, this.topPos + 15, 14, 14, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/tab_fluid_on.png"), Identifier.parse("aeroflux:textures/screens/tab_fluid_on.png")),
				e -> {
					int x = CollectorGUIScreen.this.x;
					int y = CollectorGUIScreen.this.y;
		...
		imagebutton_tab_items = new ImageButton(this.leftPos + -15, this.topPos + 30, 14, 14, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/tab_item_off.png"), Identifier.parse("aeroflux:textures/screens/tab_item_off.png")), e -> {
		}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
				guiGraphics.blit(RenderPipelines.GUI_TEXTURED, sprites.get(isActive(), isHoveredOrFocused()), getX(), getY(), 0, 0, width, height, width, height);
		...
		imagebutton_tab_items_selected = new ImageButton(this.leftPos + -15, this.topPos + 30, 14, 14, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/tab_item_on.png"), Identifier.parse("aeroflux:textures/screens/tab_item_on.png")),
				e -> {
				}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_tab_energy = new ImageButton(this.leftPos + -15, this.topPos + 46, 14, 14, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/tab_energy_off.png"), Identifier.parse("aeroflux:textures/screens/tab_energy_off.png")),
				e -> {
					int x = CollectorGUIScreen.this.x;
					int y = CollectorGUIScreen.this.y;
					if (CapabilityEnergyProcedure.execute(world, x, y, z)) {
		...
		imagebutton_tab_energy_selected = new ImageButton(this.leftPos + -15, this.topPos + 46, 14, 14,
				new WidgetSprites(Identifier.parse("aeroflux:textures/screens/tab_energy_on.png"), Identifier.parse("aeroflux:textures/screens/tab_energy_on.png")), e -> {
					int x = CollectorGUIScreen.this.x;
					int y = CollectorGUIScreen.this.y;
		...
		imagebutton_mode = new ImageButton(this.leftPos + -14, this.topPos + 141, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/mode.png"), Identifier.parse("aeroflux:textures/screens/mode.png")), e -> {
			int x = CollectorGUIScreen.this.x;
			int y = CollectorGUIScreen.this.y;
			if (true) {
		...
		imagebutton_rotate = new ImageButton(this.leftPos + -14, this.topPos + 155, 12, 12, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/rotate.png"), Identifier.parse("aeroflux:textures/screens/rotate.png")), e -> {
			int x = CollectorGUIScreen.this.x;
			int y = CollectorGUIScreen.this.y;
			if (true) {
		...
		imagebutton_settings_close = new ImageButton(this.leftPos + -66, this.topPos + 1, 9, 9, new WidgetSprites(Identifier.parse("aeroflux:textures/screens/settings_close.png"), Identifier.parse("aeroflux:textures/screens/settings_close.png")),
				e -> {
					int x = CollectorGUIScreen.this.x;
					int y = CollectorGUIScreen.this.y;
					if (SettingsStatusProcedure.execute(world)) {
