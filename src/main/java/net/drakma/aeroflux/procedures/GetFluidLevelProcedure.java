...
public class GetFluidLevelProcedure {
	public static String execute(LevelAccessor world, double x, double y, double z) {
		return new java.text.DecimalFormat("##.#%").format((double) getFluidTankLevel(world, BlockPos.containing(x, y, z), 0, null) / getFluidTankCapacity(world, BlockPos.containing(x, y, z), 0, null)) + " ["
				+ getFluidTankLevel(world, BlockPos.containing(x, y, z), 0, null) + "/" + getFluidTankCapacity(world, BlockPos.containing(x, y, z), 0, null) + "]" + "\n" + GenerationPerMinuteProcedure.execute(world, x, y, z);
	}
