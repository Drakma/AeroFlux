...
public class Filled90Procedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		if ((double) getFluidTankLevel(world, BlockPos.containing(x, y, z), 0, null) / getFluidTankCapacity(world, BlockPos.containing(x, y, z), 0, null) >= 0.95
				&& (double) getFluidTankLevel(world, BlockPos.containing(x, y, z), 0, null) / getFluidTankCapacity(world, BlockPos.containing(x, y, z), 0, null) < 1) {
			return true;
		}
		return false;
	}
