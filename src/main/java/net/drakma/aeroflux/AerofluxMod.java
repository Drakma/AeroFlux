...
import net.drakma.aeroflux.init.*;
...
@Mod("aeroflux")
public class AerofluxMod {
	public static final Logger LOGGER = LogManager.getLogger(AerofluxMod.class);
	public static final String MODID = "aeroflux";

	public AerofluxMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		AerofluxModBlocks.REGISTRY.register(modEventBus);
		AerofluxModBlockEntities.REGISTRY.register(modEventBus);
		AerofluxModItems.REGISTRY.register(modEventBus);
		AerofluxModTabs.REGISTRY.register(modEventBus);
		AerofluxModVariables.ATTACHMENT_TYPES.register(modEventBus);
		AerofluxModMenus.REGISTRY.register(modEventBus);
		AerofluxModParticleTypes.REGISTRY.register(modEventBus);
		AerofluxModFluids.REGISTRY.register(modEventBus);
		AerofluxModFluidTypes.REGISTRY.register(modEventBus);
