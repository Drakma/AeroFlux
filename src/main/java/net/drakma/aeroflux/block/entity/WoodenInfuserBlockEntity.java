...
public class WoodenInfuserBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(5, ItemStack.EMPTY);

	public WoodenInfuserBlockEntity(BlockPos position, BlockState state) {
		super(AerofluxModBlockEntities.WOODEN_INFUSER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("wooden_infuser");
	}
