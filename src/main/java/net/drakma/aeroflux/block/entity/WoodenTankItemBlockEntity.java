...
public class WoodenTankItemBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(2, ItemStack.EMPTY);

	public WoodenTankItemBlockEntity(BlockPos position, BlockState state) {
		super(AerofluxModBlockEntities.WOODEN_TANK_ITEM.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("wooden_tank_item");
	}
