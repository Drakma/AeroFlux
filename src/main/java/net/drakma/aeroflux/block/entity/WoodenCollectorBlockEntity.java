...
public class WoodenCollectorBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(0, ItemStack.EMPTY);

	public WoodenCollectorBlockEntity(BlockPos position, BlockState state) {
		super(AerofluxModBlockEntities.WOODEN_COLLECTOR.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("wooden_collector");
	}
